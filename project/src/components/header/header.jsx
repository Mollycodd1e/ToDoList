...
function Header(props) {
  ...
  const swipeItems = () => {
    const listOfTasks = Array.from(document.querySelector('.main-page__list').querySelectorAll('li'))
      ...
      <nav className="main-nav">
        <ul className="main-nav__list">
          <li>
            ...
            {hide === false ?
              <button onClick={() => {
                return (hide === false ? (hideHandler(true), swipeItems()) : (hideHandler(false), swipeItems()));
              }
              }>
